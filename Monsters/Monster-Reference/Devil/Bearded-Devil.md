...
actions:
    - name: "Wicked halberd +11 vs. AC"
      ...
      traits:
          - name: "Natural 16+"
            desc: "The bearded devil gains a +4 bonus to all defenses until the start of its next turn."
    - name: "Supernaturally filthy beard +11 vs. PD"
      desc: "The target is weakened until the end of its next turn (–4 attacks and defenses)"
traits:
