...
actions:
    - name: "Swarm +7 vs. AC"
      desc: "5 damage<br/>[Group ability]C: Puppeteer tentacles +7 vs. MD (one nearby enemy)—The target makes a basic attack against a target of the xombie egg swarm’s choice"
      traits:
          - name: "Miss"
...
nastier_traits:
    - name: "Corpse puppet"
      desc: "If there is at least one intact corpse in the battle (say a star-mask cultist died), then once per battle part of the xombie egg swarm can burrow into it as a quick action, and it rises as a skull crab xombie at the start of the next round (roll initiative and give the new xombie a +10 initiative bonus for the shock of its arrival)."
ac: "18"
pd: "12"
md: "16"
hp: "9"
