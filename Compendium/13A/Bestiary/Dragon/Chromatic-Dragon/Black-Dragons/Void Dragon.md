    ...
    - name: "Jaws and claws +12 vs. AC (2 attacks)"
      ...
      traits:
          - name: "Natural 5, 10, 15, or 20"
            desc: "The dragon regains the use of its ensorceling breath if it’s expended and can use it during its next turn."
          - name: "Miss"
            desc: "13 damage."
    - name: "C: Ensorceling breath +12 vs. PD (1d3 nearby enemies)"
      desc: "24 damage, and the dragon’s breath coalesces into two small void beasts of rapidly shifting form (see below)"
      traits:
          - name: "Miss"
            desc: "The dragon’s breath coalesces into one small void beast (see below)."
          - name: "Void beasts"
            desc: "Each beast appears next to the dragon, acts as it wishes, and enters the initiative order after the next two creatures have taken their turns. See void beast stats at end of the entry."
          - name: "Limited use"
...
triggered_actions:
    - name: "Slam +11 vs. AC"
      ...
      traits:
          - name: "Natural 5, 10, 15, or 20"
            desc: "The void beast spawns a new void beast at full hit points. It follows the same rules for beasts formed by ensorceling breath."
ac: "23"
pd: "21"
md: "19"
hp: "290"
