...
role: spoiler
strength: large
tags: ["13A/Bestiary/Beast", "13A/Monsters/Factions/Manticores", "13A/Monsters/Type/Spoiler"]
type: beast
updated: 2023-05-30
---
...
actions:
    - name: "Battering paws +11 vs. AC (2 attacks)"
      ...
      traits:
          - name: "Natural 16+"
            desc: "The manticore can make a scorpion sting attack against a different target as a free action."
...
traits:
    - name: "Fly-by attack"
      desc: "While flying, the manticore can make a scorpion sting attack, pop free from the target, and keep flying to somewhere nearby."
    - name: "Flight"
    ...
    - name: "Poison reservoirs"
      desc: "Each time the manticore uses its scorpion sting attack, it takes 1d6 damage, or 2d6 damage if it’s staggered."
nastier_traits:
    - name: "Aerial archer"
      desc: "Instead of a scorpion tail, the manticore has a spiked tail full of quills and can make volley of tail spikes attacks instead of scorpion sting attacks."
    - name: "Diving leap"
