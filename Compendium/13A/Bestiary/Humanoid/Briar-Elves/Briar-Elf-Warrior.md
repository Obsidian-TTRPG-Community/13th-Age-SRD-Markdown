...
traits:
    - name: "The poison builds"
      desc: "For each nearby enemy that is taking ongoing damage, the briar elf warrior’s attacks deal an additional 10 poison damage, hit or miss.<br/>Choose one"
    - name: "Humanoid (default): The briar elf can make the following ranged attack"
      desc: ""
    - name: "Plant"
