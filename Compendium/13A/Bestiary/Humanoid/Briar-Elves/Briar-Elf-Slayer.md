...
traits:
    - name: "Counterstrike"
      desc: "When the briar elf is targeted by an opportunity attack, it makes a thorn claws attack against the creature that is targeting it first.<br/>Choose one"
    - name: "Humanoid: The briar elf can make the following ranged attack"
      desc: ""
    - name: "Plant"
