...
traits:
    - name: "Devil’s due (Mwhahahah!)"
      desc: "When you choose to add the escalation die to an attack against a hell imp, the imp automatically hits with its next needling taunt attack this battle, and the target takes 2d6 extra psychic damage."
    - name: "Flight"
