...
traits:
    ...
    - name: "Mutated form"
      desc: "Since different creatures become hellwarped beasts, some are tougher or hardier than others. Before battle, roll a d8 and adjust the hellwarped’s stats accordingly.<br/>1. –2 to all defenses<br/>2. +2 to all defenses<br/>3. –10% to hit points (–65)<br/>4. +10% to hit points (+65)<br/>5. –1 to all attacks<br/>6. +1 to all attacks<br/>7. Only roll once on the Aberrant Attack table<br/>8. Roll three times instead of twice on the Aberrant Attack table"
nastier_traits:
    - name: "Special movement"
      desc: "The hellwarped brute has flight, burrow, an extra move action, the ability to teleport as a move action, or some other movement related ability of your choice. Decrease all its defenses by 1 due to the weak points this anatomy creates."
