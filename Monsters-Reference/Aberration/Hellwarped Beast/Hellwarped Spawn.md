...
traits:
    ...
    - name: "Mutated form"
      desc: "Since different creatures become hellwarped beasts, some are tougher or hardier than others. Before battle, roll a d6 and adjust the hellwarped’s stats accordingly.<br/>1. –2 to all defenses<br/>2. +2 to all defenses<br/>3. –10% to hit points (–18)<br/>4. +10% to hit points (+18)<br/>5. –1 to all attacks<br/>6. +1 to all attacks"
nastier_traits:
    - name: "Special movement"
      desc: "The hellwarped has flight, burrow, an extra move action, the ability to teleport as a move action, or some other movement related ability of your choice. Decrease all its defenses by 1 due to the weak points this anatomy creates."
