...
triggered_actions:
    - name: "Soporific bite +6 vs. PD"
      desc: "The target rolls a save. If it fails, the target is helpless (–4 to all defenses) as it falls unconscious (save ends, or taking 10 damage ends). When a creature falls unconscious this way, each other nearby dainty lizard that is not already engaged will move and attack the target during its next turn."
ac: "16"
pd: "14"
md: "12"
hp: "9"
