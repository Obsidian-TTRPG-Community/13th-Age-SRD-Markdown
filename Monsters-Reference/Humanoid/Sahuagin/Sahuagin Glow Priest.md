    ...
    - name: "R: Glowpriest’s prayer +10 vs. MD (1d3 nearby enemies)"
      ...
      traits:
          ...
          - name: "7–8 (Word of refuge)"
            desc: "Remove the glowpriest from play. At the start of its next turn, return it to play nearby its original location. It gains a +4 bonus to all defenses until the end of its next turn after it returns to play."
traits:
    - name: "Water breather"
