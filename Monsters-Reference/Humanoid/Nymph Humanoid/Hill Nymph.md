...
actions:
    ...
    - name: "C: Hard words +9 vs. MD (1d3 nearby enemies)"
      desc: "20 psychic damage, and the target is overcome by the cold beauty and piercing words of the oread (save ends); while overcome, the target takes a penalty to all defenses equal to the escalation die"
      traits:
          - name: "Natural 16+"
